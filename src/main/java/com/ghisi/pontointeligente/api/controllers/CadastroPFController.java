package com.ghisi.pontointeligente.api.controllers;
...
import com.ghisi.pontointeligente.api.dtos.CadastroPFDto;
...
import com.ghisi.pontointeligente.api.response.Response;
import com.ghisi.pontointeligente.api.services.EmpresaService;
import com.ghisi.pontointeligente.api.services.FuncionarioService;
import com.ghisi.pontointeligente.api.utils.PasswordUtils;
...
public class CadastroPFController {
	...
	public ResponseEntity<Response<CadastroPFDto>> cadastrar(@Valid @RequestBody CadastroPFDto cadastroPFDto,
		...
		Optional<Empresa> empresa = this.empresaService.buscarCnpj(cadastroPFDto.getCnpj());
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getHorasAlmocoOpt().ifPresent(qtdHorasAlmoco -> cadastroPFDto
